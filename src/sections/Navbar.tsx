        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-5 flex items-center justify-between gap-3">
          ...
          <nav className="hidden md:flex items-center gap-7">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-sm font-semibold bg-[#d4af37] text-[#14100a] px-4 py-2 rounded-md hover:bg-[#e9c65a] transition-colors"
            >
              Contáctanos
            </a>
          </nav>
        ...
        {open && (
          <nav className="md:hidden max-h-[calc(100dvh-5rem)] overflow-y-auto bg-[#0c0a07]/98 backdrop-blur-md border-t border-[#d4af37]/20 px-5 py-5 flex flex-col gap-1">
            ...
            <a
              ...
              rel="noreferrer"
              onClick={() => setOpen(false)}
              className="mt-4 text-center font-semibold bg-[#d4af37] text-[#14100a] px-4 py-3 rounded-md"
            >
              Contáctanos
            </a>
          </nav>
